  ...
  return (
    <div className="w-[85%] mx-auto mb-20 ">
      <div className="max-w-fit ml-[-30px]">
        ...
        {/* border bottom  */}
        <div id="border-bottom-1" className="mt-2 w-32 mx-auto h-[6px] rounded-full bg-customBlue"></div>
      </div>
      <div className="mt-10 grid grid-row-2 grid-cols-3 gap-x-10 gap-y-16">
        {
            data.map((item,index) => {
               return ( <div key={index} className="space-y-5">
                    ...
                    <p id="text" className="px-5 relative text-xl text-justify">AIC_PECF Services for startups, innovators, industries, and academia to colloborate with us and advance their innovations</p>
                    </div>
                </div> )
            })
        }
